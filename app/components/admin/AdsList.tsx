...
import { AdSlot, AD_SLOT_NAMES, VIDEO_AD_SLOTS } from '@/types/ads';
    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-4">
          {displayedAds.map(ad => (
            <div key={ad.id} className="border border-gray-300 rounded-lg p-4 bg-white shadow-sm">
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4 items-start">
                ...
                <div className="md:col-span-2 space-y-2">
                  <p className="font-bold text-gray-900">{ad.companyName}</p>
                  <p className="text-sm text-gray-600">
                    Slot: <span className="font-semibold text-blue-600">{AD_SLOT_NAMES[ad.adSlot as AdSlot] || ad.adSlot}</span>
                    {VIDEO_AD_SLOTS.includes(ad.adSlot as AdSlot) && <span className="ml-2 text-red-500">🎬 VIDEO</span>}
                  </p>
                ...
                <div className="md:col-span-1">
                  {editingId === ad.id ? (
                    ...
                    <div
                      ...
                      className="cursor-pointer p-2 bg-gray-50 rounded hover:bg-gray-100 transition"
                    >
                      <p className="text-sm text-gray-600">Revenue</p>
                      <p className="font-bold text-green-600">₹{ad.revenue}</p>
                    </div>
                  )}
                </div>
